...
![Collides With](images/crash-course-32.png)

6) Click the **OK** button in the bottom-right to dismiss the window.

![OK](images/crash-course-33.png)
...
![Actor Types](images/crash-course-7.png)
...
![Properties](images/crash-course-17.png)
...
![Choose Group](images/crash-course-18.png)

3) Visit the **Physics** page by clicking the **Physics button** at the top of the editor.

![Physics Button](images/crash-course-19.png)
...
![Can Rotate?](images/crash-course-20.png)
...
![Behaviors](images/crash-course-21.png)
...
![Choose a Behavior](images/crash-course-22.png)
...
![Walking](images/crash-course-23.png)
...
![Control Attributes](images/crash-course-24.png)
...
![Animation Attributes](images/crash-course-25.png)
...
![Add Behavior](images/crash-course-26.png)
...
* **Jumping:** Make the following modifications to the default values: Choose _**action1**_ for **Jump Key**. Add the **Jump Sound** so Stencyl will play a sound effect when Noni jumps. Finally, choose _**Jump Right**_ and _**Jump Left**_ for the **Jump Right** and **Jump Left** animations, respectively. 
 ...
 ![Jumping](images/crash-course-27.png)
...
* **Stomp on Enemies:** Set **Stompable Group** to _**Enemies**_ (the group we created at the beginning of this section) and **Jump Key** to _**action1**_.
 ...
 ![Stomp on Enemies](images/crash-course-34.png)
...
![Stompable Behavior](images/crash-course-36.png)
