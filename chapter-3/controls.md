...
To make this, you can use the **when any key is pressed/released** event for this kind of user input.

![Example](<img alt="" src="https://dl.dropboxusercontent.com/u/4236876/stencyl/textinput.png">)
...
* The block also takes modifier keys into account, so pressing A while holding the SHIFT key, generates the upper-case character "A".
